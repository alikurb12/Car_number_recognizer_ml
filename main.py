...
def carplate_extract(image, carplate_haar_cascade):
    ...
    for x, y, w, h in carplate_rects:
        carplate_img = image[y+15:y+h-10, x+15:x+w-30]
...
def main():
    carplate_img_rgb = open_img(img_path='images/img2.jpg')
    ...
    # print('Номер авто: ', pytesseract.image_to_string(carplate_extract_img_gray, lang='eng'))
    reader = easyocr.Reader(['en'])
    result = reader.readtext(carplate_extract_img_gray, detail=0)
    print(result)
